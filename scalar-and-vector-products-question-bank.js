...
(() => {
  ...
  const questions = [
    ...
    {q:'If A·B = 0 for two non-zero vectors, the angle between them is:',o:['0°','45°','90°','180°'],a:2,e:'A·B = AB cosθ = 0, so θ = 90°.'},
    {q:'The scalar product A·A is equal to:',o:['A','2A','A²','0'],a:2,e:'A·A = A².'},
    {q:'The vector A × B is perpendicular to:',o:['A only','B only','Both A and B','Neither'],a:2,e:'The cross product is perpendicular to both vectors.'},
    {q:'The magnitude of A × B is maximum when the angle between A and B is:',o:['0°','30°','90°','180°'],a:2,e:'AB sinθ is maximum at 90°.'},
    {q:'If |A| = 4, |B| = 5 and θ = 60°, A·B equals:',o:['5','10','20','20√3'],a:1,e:'A·B = 4 × 5 × cos60° = 10.'},
    {q:'If |A| = 3, |B| = 4 and θ = 90°, |A × B| is:',o:['1','7','12','0'],a:2,e:'|A × B| = 3 × 4 = 12.'},
    {q:'The dot product is also known as the:',o:['Vector product','Cross product','Scalar product','Mixed product'],a:2,e:'A·B is the scalar or dot product.'},
    {q:'The cross product is also known as the:',o:['Scalar product','Vector product','Dot product','Ordinary product'],a:1,e:'A × B is the vector or cross product.'},
    {q:'If A and B are parallel in the same direction, A·B is:',o:['0','AB','−AB','A + B'],a:1,e:'For θ = 0°, A·B = AB.'},
    {q:'If A and B are antiparallel, A·B is:',o:['AB','0','−AB','A + B'],a:2,e:'For θ = 180°, A·B = −AB.'},
    {q:'If A and B are perpendicular, |A × B| is:',o:['0','AB','A + B','|A − B|'],a:1,e:'At 90°, |A × B| = AB.'},
    {q:'Which operation is commutative?',o:['A × B = B × A','A·B = B·A','Both cross and dot products','Neither'],a:1,e:'The dot product is commutative.'},
    {q:'For the cross product, which relation is correct?',o:['A × B = B × A','A × B = −(B × A)','A × B = A·B','A × B = 0 always'],a:1,e:'The cross product is anti-commutative.'},
    {q:'The unit vector perpendicular to both i and j is:',o:['i','j','k','−i'],a:2,e:'i × j = k.'},
    {q:'The value of i·j is:',o:['1','−1','0','k'],a:2,e:'i and j are perpendicular.'},
    {q:'The value of i × j is:',o:['i','j','k','0'],a:2,e:'i × j = k.'},
    {q:'The value of j × i is:',o:['i','j','k','−k'],a:3,e:'j × i = −k.'},
    {q:'If A·B is positive, the angle between A and B is:',o:['Acute','Exactly 90°','Obtuse','Exactly 180°'],a:0,e:'The dot product is positive for an acute angle.'},
    {q:'If A·B is negative, the angle between A and B is:',o:['Acute','90°','Obtuse','0°'],a:2,e:'The dot product is negative for an obtuse angle.'},
    {q:'The work done by a constant force F through displacement s is expressed as:',o:['F × s','F·s','F/s','F + s'],a:1,e:'Work is W = F·s.'},
    {q:'The torque of a force F about a point with position vector r is:',o:['r·F','r × F','r + F','r − F'],a:1,e:'Torque is τ = r × F.'},
    ...
    {q:'The scalar triple product A·(B × C) gives a:',o:['Vector','Scalar','Unit vector','Matrix'],a:1,e:'The scalar triple product is a scalar.'},
    {q:'The magnitude of A × B represents the area of the:',o:['Triangle formed by A and B','Parallelogram formed by A and B','Circle formed by A and B','Square formed by A and B'],a:1,e:'|A × B| is the area of the parallelogram.'}
  ];
  window.SkillUpMCQBanks = window.SkillUpMCQBanks || {};
  window.SkillUpMCQBanks[topic] = questions;
